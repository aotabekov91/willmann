...
class FlashcardMode(GenericMode):

    def __init__(self, port=None, parent_port=None, config=None):

        super(FlashcardMode, self).__init__(
                 name='Flashcard', 
                 port=port, 
    ...
    @register('c')
    def create(self, preserve=False):
    ...
    def submit(self, note=None):
        ...
        try:
            self.submitter.addNotes(self.note)
